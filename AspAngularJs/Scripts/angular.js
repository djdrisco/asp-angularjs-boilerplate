/**
 * @license AngularJS v1.3.7-local+sha.8a907eb
...
function minErr(module, ErrorConstructor) {
  ...
  return function() {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.7-local+sha.8a907eb/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.7-local+sha.8a907eb',    // all of these placeholder strings will be replaced by grunt's
